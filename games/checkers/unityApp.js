const unityApp = {
    ...
    tryLockAspectRatio() {
        const mobilePortraitAspectRatio = "9/16";
        const mobileLandscapeAspectRatio = "16/9";
    ...
    startLoading: function () {
        ...
        const loaderUrl = buildUrl + "/Checkers[3]-mirraSDK[5.0.17].loader.js";
        const config = {
            arguments: [],
            dataUrl: buildUrl + "/Checkers[3]-mirraSDK[5.0.17].data.unityweb",
            frameworkUrl: buildUrl + "/Checkers[3]-mirraSDK[5.0.17].framework.js.unityweb",
            codeUrl: buildUrl + "/Checkers[3]-mirraSDK[5.0.17].wasm.unityweb",
            streamingAssetsUrl: "StreamingAssets",
            companyName: "PajaceStudios",
