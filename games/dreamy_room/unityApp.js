const unityApp = {
    ...
    startLoading: function () {
        ...
        const config = {
            arguments: [],
            dataUrl: buildUrl + "/8471f5b2d83243720a76b4fe49eaf19e.data",
            frameworkUrl: buildUrl + "/47c6a735bf47fed158ec5848b34d807e.framework.js",
            codeUrl: buildUrl + "/781a7100843a90cfe4746b94c577fc4f.wasm",
            streamingAssetsUrl: "StreamingAssets",
            companyName: "DefaultCompany",
            productName: "DreamyRoom_2",
            productVersion: "1.0",
            showBanner: (msg, type) => {
                switch (type) {
                    case 'error': {
