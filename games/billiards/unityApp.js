const unityApp = {
    ...
    tryLockAspectRatio() {
        ...
        const mobileLandscapeAspectRatio = "2.1";
        const desktopAspectRatio = "1.77";
    ...
    startLoading: function () {
        ...
        const loaderUrl = buildUrl + "/billiards[18]-mirraSDK[5.0.17].loader.js";
        const config = {
            arguments: [],
            dataUrl: buildUrl + "/billiards[18]-mirraSDK[5.0.17].data.unityweb",
            frameworkUrl: buildUrl + "/billiards[18]-mirraSDK[5.0.17].framework.js.unityweb",
            codeUrl: buildUrl + "/billiards[18]-mirraSDK[5.0.17].wasm.unityweb",
