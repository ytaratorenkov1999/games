const unityApp = {
    ...
    startLoading: function () {
        ...
        const loaderUrl = buildUrl + "/SpaceCraft[1]-primeSDK[5.2.7].loader.js";
        const config = {
            arguments: [],
            dataUrl: buildUrl + "/SpaceCraft[1]-primeSDK[5.2.7].data.unityweb",
            frameworkUrl: buildUrl + "/SpaceCraft[1]-primeSDK[5.2.7].framework.js.unityweb",
            codeUrl: buildUrl + "/SpaceCraft[1]-primeSDK[5.2.7].wasm.unityweb",
