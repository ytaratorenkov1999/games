const unityApp = {
    ...
    startLoading: function () {
        ...
        const loaderUrl = buildUrl + "/SpaceCraft[9]-mirraSDK[5.1.20].loader.js";
        const config = {
            arguments: [],
            dataUrl: buildUrl + "/SpaceCraft[9]-mirraSDK[5.1.20].data.unityweb",
            frameworkUrl: buildUrl + "/SpaceCraft[9]-mirraSDK[5.1.20].framework.js.unityweb",
            codeUrl: buildUrl + "/SpaceCraft[9]-mirraSDK[5.1.20].wasm.unityweb",
            streamingAssetsUrl: "StreamingAssets",
            companyName: "koro.games",
            productName: "Space Craft",
            productVersion: "0.1",
            showBanner: (msg, type) => {
                switch (type) {
                    case 'error': {
