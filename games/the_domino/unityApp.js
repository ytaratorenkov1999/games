const unityApp = {
    ...
    startLoading: function () {
        ...
        const loaderUrl = buildUrl + "/TheDomino[25]-mirraSDK[5.1.14].loader.js";
        const config = {
            arguments: [],
            dataUrl: buildUrl + "/TheDomino[25]-mirraSDK[5.1.14].data.unityweb",
            frameworkUrl: buildUrl + "/TheDomino[25]-mirraSDK[5.1.14].framework.js.unityweb",
            codeUrl: buildUrl + "/TheDomino[25]-mirraSDK[5.1.14].wasm.unityweb",
            streamingAssetsUrl: "StreamingAssets",
            companyName: "DefaultCompany",
            productName: "TheDomino",
            productVersion: "1.0",
            showBanner: (msg, type) => {
                switch (type) {
                    case 'error': {
