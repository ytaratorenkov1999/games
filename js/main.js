(() => {
    ...
    const e = document.querySelector(".swiper-wrapper"),
        ...
        a = [{
            ...
            ru: {
                title: "Нарды",
                desc: "Игра для двух игроков, цель игрока во время игры — бросая кости и передвигая шашки в соответствии с выпавшими очками, переместить все свои шашки в определённую область игрового поля раньше противника."
            },
            en: {
                title: "Backgammon",
