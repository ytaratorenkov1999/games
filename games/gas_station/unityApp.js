const unityApp = {
    ...
    startLoading: function () {
        ...
        const loaderUrl = buildUrl + "/GasStation[1]-mirraSDK[5.1.20].loader.js";
        const config = {
            arguments: [],
            dataUrl: buildUrl + "/GasStation[1]-mirraSDK[5.1.20].data.unityweb",
            frameworkUrl: buildUrl + "/GasStation[1]-mirraSDK[5.1.20].framework.js.unityweb",
            codeUrl: buildUrl + "/GasStation[1]-mirraSDK[5.1.20].wasm.unityweb",
