const unityApp = {
    ...
    startLoading: function () {
        ...
        const loaderUrl = buildUrl + "/tb-game.loader.js";
        const config = {
            arguments: [],
            dataUrl: buildUrl + "/tb-game.data.unityweb",
            frameworkUrl: buildUrl + "/tb-game.framework.js.unityweb",
            codeUrl: buildUrl + "/tb-game.wasm.unityweb",
