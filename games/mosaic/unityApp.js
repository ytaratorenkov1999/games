const unityApp = {
    ...
    startLoading: function () {
        ...
        const loaderUrl = buildUrl + "/Mosaic[1]-primeSDK[5.1.53].loader.js";
        const config = {
            arguments: [],
            dataUrl: buildUrl + "/Mosaic[1]-primeSDK[5.1.53].data.unityweb",
            frameworkUrl: buildUrl + "/Mosaic[1]-primeSDK[5.1.53].framework.js.unityweb",
            codeUrl: buildUrl + "/Mosaic[1]-primeSDK[5.1.53].wasm.unityweb",
            streamingAssetsUrl: "StreamingAssets",
            companyName: "Technocore",
            productName: "Мозаика игра арт пазлы и головоломки",
            productVersion: "0.123r",
            showBanner: (msg, type) => {
                switch (type) {
                    case 'error': {
                        console.error(msg);
