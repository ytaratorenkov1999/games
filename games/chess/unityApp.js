const unityApp = {
    ...
    startLoading: function () {
        ...
        const loaderUrl = buildUrl + "/Chess[2]-mirraSDK[5.0.17].loader.js";
        const config = {
            arguments: [],
            dataUrl: buildUrl + "/Chess[2]-mirraSDK[5.0.17].data.unityweb",
            frameworkUrl: buildUrl + "/Chess[2]-mirraSDK[5.0.17].framework.js.unityweb",
            codeUrl: buildUrl + "/Chess[2]-mirraSDK[5.0.17].wasm.unityweb",
            streamingAssetsUrl: "StreamingAssets",
            companyName: "Sebastian Lague",
            productName: "Chess",
            productVersion: "2.0",
            showBanner: (msg, type) => {
                switch (type) {
