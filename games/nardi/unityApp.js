const unityApp = {
    ...
    startLoading: function () {
        ...
        const loaderUrl = buildUrl + "/Backgammon3D[1]-mirraSDK[5.0.17].loader.js";
        const config = {
            arguments: [],
            dataUrl: buildUrl + "/Backgammon3D[1]-mirraSDK[5.0.17].data.unityweb",
            frameworkUrl: buildUrl + "/Backgammon3D[1]-mirraSDK[5.0.17].framework.js.unityweb",
            codeUrl: buildUrl + "/Backgammon3D[1]-mirraSDK[5.0.17].wasm.unityweb",
            streamingAssetsUrl: "StreamingAssets",
            companyName: "MirraGames",
            productName: "Backgammon3D",
            productVersion: "0.1",
            showBanner: (msg, type) => {
                switch (type) {
                    case 'error': {
