const unityApp = {
    ...
    startLoading: function () {
        ...
        const loaderUrl = buildUrl + "/traffic_rider.loader.js";
        const config = {
            arguments: [],
            dataUrl: buildUrl + "/traffic_rider.data.unityweb",
            frameworkUrl: buildUrl + "/traffic_rider.framework.js.unityweb",
            codeUrl: buildUrl + "/traffic_rider.wasm.unityweb",
            streamingAssetsUrl: "StreamingAssets",
            companyName: "MirraGames",
            productName: "Мотогонщик Дорожный Беспредел",
            productVersion: "1.1",
            showBanner: (msg, type) => {
                switch (type) {
                    case 'error': {
