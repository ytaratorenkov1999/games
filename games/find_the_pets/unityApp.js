const unityApp = {
    ...
    startLoading: function () {
        ...
        const loaderUrl = buildUrl + "/6d0c4621d29d41a08d4e80b0895d14f9.loader.js";
        const config = {
            arguments: [],
            dataUrl: buildUrl + "/70608ee0d23e1c2729b4c64638f086a7.data.unityweb",
            frameworkUrl: buildUrl + "/1553c34d9912d39808d8ea570435b79c.framework.js.unityweb",
            codeUrl: buildUrl + "/c168ac578fb3ac24cbccf36915c6e03e.wasm.unityweb",
            streamingAssetsUrl: "StreamingAssets",
            companyName: "Poison Studio LLC",
            productName: "Find the Pets",
            productVersion: "1.6",
            showBanner: (msg, type) => {
                switch (type) {
                    case 'error': {
