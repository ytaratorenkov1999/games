const unityApp = {
    ...
    startLoading: function () {
        ...
        const loaderUrl = buildUrl + "/DinosaurLand[3]-mirraSDK[5.1.20].loader.js";
        const config = {
            arguments: [],
            dataUrl: buildUrl + "/DinosaurLand[3]-mirraSDK[5.1.20].data.unityweb",
            frameworkUrl: buildUrl + "/DinosaurLand[3]-mirraSDK[5.1.20].framework.js.unityweb",
            codeUrl: buildUrl + "/DinosaurLand[3]-mirraSDK[5.1.20].wasm.unityweb",
            streamingAssetsUrl: "StreamingAssets",
            companyName: "NeverGames",
            productName: "DinosaurLand",
