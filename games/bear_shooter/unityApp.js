const unityApp = {
    ...
    startLoading: function () {
        ...
        const loaderUrl = buildUrl + "/BearShooter[2]-primeSDK[5.1.53].loader.js";
        const config = {
            arguments: [],
            dataUrl: buildUrl + "/BearShooter[2]-primeSDK[5.1.53].data.unityweb",
            frameworkUrl: buildUrl + "/BearShooter[2]-primeSDK[5.1.53].framework.js.unityweb",
            codeUrl: buildUrl + "/BearShooter[2]-primeSDK[5.1.53].wasm.unityweb",
            streamingAssetsUrl: "StreamingAssets",
            companyName: "GoldenDreamStudio",
            productName: "BearShooter",
            productVersion: "1.0",
            showBanner: (msg, type) => {
                switch (type) {
                    case 'error': {
