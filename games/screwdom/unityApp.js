const unityApp = {
    ...
    startLoading: function () {
        ...
        const loaderUrl = buildUrl + "/Screwdom3D[2]-mirraSDK[5.1.20].loader.js";
        const config = {
            arguments: [],
            dataUrl: buildUrl + "/Screwdom3D[2]-mirraSDK[5.1.20].data.unityweb",
            frameworkUrl: buildUrl + "/Screwdom3D[2]-mirraSDK[5.1.20].framework.js.unityweb",
            codeUrl: buildUrl + "/Screwdom3D[2]-mirraSDK[5.1.20].wasm.unityweb",
            streamingAssetsUrl: "StreamingAssets",
            companyName: "GB Games",
            productName: "Screwdom3D",
            productVersion: "0.1",
            showBanner: (msg, type) => {
                switch (type) {
                    case 'error': {
