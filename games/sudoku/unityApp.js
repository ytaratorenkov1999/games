const unityApp = {
    ...
    startLoading: function () {
        ...
        const loaderUrl = buildUrl + "/Sudoko[2]-mirraSDK[5.0.17].loader.js";
        const config = {
            arguments: [],
            dataUrl: buildUrl + "/Sudoko[2]-mirraSDK[5.0.17].data.unityweb",
            frameworkUrl: buildUrl + "/Sudoko[2]-mirraSDK[5.0.17].framework.js.unityweb",
            codeUrl: buildUrl + "/Sudoko[2]-mirraSDK[5.0.17].wasm.unityweb",
