const unityApp = {
    ...
    startLoading: function () {
        ...
        const loaderUrl = buildUrl + "/HorrorHaze[1]-mirraSDK[5.1.20].loader.js";
        const config = {
            arguments: [],
            dataUrl: buildUrl + "/HorrorHaze[1]-mirraSDK[5.1.20].data.unityweb",
            frameworkUrl: buildUrl + "/HorrorHaze[1]-mirraSDK[5.1.20].framework.js.unityweb",
            codeUrl: buildUrl + "/HorrorHaze[1]-mirraSDK[5.1.20].wasm.unityweb",
            streamingAssetsUrl: "StreamingAssets",
            companyName: "Horror Haze",
            productName: "Horror Haze",
            productVersion: "1.0",
            showBanner: (msg, type) => {
                switch (type) {
                    case 'error': {
