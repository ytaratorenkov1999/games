const unityApp = {
    ...
    startLoading: function () {
        ...
        const loaderUrl = buildUrl + "/magessecret_prime_aero.loader.js";
        const config = {
            arguments: [],
            dataUrl: buildUrl + "/magessecret_prime_aero.data.unityweb",
            frameworkUrl: buildUrl + "/magessecret_prime_aero.framework.js.unityweb",
            codeUrl: buildUrl + "/magessecret_prime_aero.wasm.unityweb",
            streamingAssetsUrl: "StreamingAssets",
            companyName: "GeekyHouse",
            productName: "magessecret",
